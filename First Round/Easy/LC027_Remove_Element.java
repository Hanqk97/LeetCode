package Easy;//Given an integer array nums and an integer val, remove all occurrences of val in nums in-place.
...
public class LC027_Remove_Element {
    ...
    public void forward(int[] nums, int index){
    ...
    public static void main(String[] args) {
        int[] s1 = {3,2,2,3};
        int v1 = 3;
        int[] s2 = {0,1,2,2,3,0,4,2};
        int v2 = 2;

        LC027_Remove_Element a = new LC027_Remove_Element();
        System.out.println(a.removeElement(s1,v1));
        System.out.println(a.removeElement(s2,v2));
    }
}
